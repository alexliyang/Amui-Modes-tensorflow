...
tf.app.flags.DEFINE_string('data_dir', '/home/ccx/AmuiData/cifar-10-batches-bin',  """Path to the data directory.""")
...
def distorted_inputs():
  ...
  return data_input.distorted_inputs(data_dir=FLAGS.data_dir, batch_size=FLAGS.batch_size)

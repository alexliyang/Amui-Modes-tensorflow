...
def read_datasets(filename_queue):
...
def __get_cifar10_data_file_names():
  '''
...
def distorted_inputs(data_dir, batch_size):
  ...
  filenames = __get_cifar10_data_file_names() # ccx change
  ...
  read_input = read_datasets(filename_queue)
